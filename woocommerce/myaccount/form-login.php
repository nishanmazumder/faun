...
<div class="u-columns col2-set nm_login_reg_area" id="customer_login">

	<div class="u-column1 col-1 nm_login">

<?php endif; ?>

		<h2><?php esc_html_e( 'Sign In', 'woocommerce' ); ?></h2>
		<p>Already registered? Login with email.</p>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="form-row">
				<label class="nm_check_box woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	...
	<div class="nm_form_seperator">
		...
		<div class="nm_form_seperator_line"></div>
	</div>

	<div class="u-column2 col-2 nm_register">

		<h2><?php esc_html_e( 'Register', 'woocommerce' ); ?></h2>
		<p>New customer? Create an account for a faster experience.</p>
